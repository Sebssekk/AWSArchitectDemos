...
- Some resources will also generate traces, who are visible in the **[AWS Xray](https://aws.amazon.com/xray)** console, like the `snack-generator-function` from [Module 5](../mod04-compute/README.md) 
